...
import { topSuppliersData } from '../../data/mockData';
import './Tables.css';
  ...
  return (
    <div className="chart-card table-card">
      <div className="chart-card__header">
        <h3 className="chart-card__title">Top 5 Suppliers</h3>
      ...
      <div className="table-card__body">
        ...
        <div className="table-card__footer">
          <a href="#" className="view-all-link">View All Suppliers <span>→</span></a>
        </div>
      </div>
    </div>
  );
